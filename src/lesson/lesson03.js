...
function Lesson03() {
  ...
  commandsReference = commandsReference.concat([Constants.References.PUT_COMPONENT]);
  ...
  commandsReference = commandsReference.concat([Constants.References.COMPONENT_SENSOR]);
  ...
  commandsReference = commandsReference.concat([Constants.References.MACHINE_SENSOR]);
